...
<p class="browsehappy">Вы используете <strong>устаревший </strong>браузер. Пожалуйста <a href="http://browsehappy.com"
                                                                                         target="_blank">обновите
    браузер </a>для лучшего отображения сайта.</p>
<![endif]-->
                    ...
                    <div class="header__wrapper header__wrapper_full-md">
                            ...
                            <div class="header__social">
                                ...
                                <div class="social-small">
                                    ...
                                    <a rel="nofollow" class="social-small__item" href="https://twitter.com/weltkind">
                                        <img src="/img/soc-tw.png" alt="Twitter">
                                    </a>
                                </div>
                                <!--/noindex-->
                            </div>
                        ...
                        <div class="header__more">
                            <div class="header__phone">
                                <a href="tel:+996551911466">+ 996 551 911 466</a>
                            </div>
                                                     ...
                                                     data-header="false">
                                                        <span style="vertical-align: bottom; width: 450px; height: 154px;">
                                                            <iframe class width="450" name="f100164b560ce1a"
                                                                    ...
                                                                    style="border: medium none; visibility: visible; width: 450px; height: 154px;"
                                                                    height="200"></iframe>
                                                        </span>
                                                </div>
                                            </div>
                                                     ...
                                                     data-font="verdana">
                                                        <span style="vertical-align: bottom; width: 123px; height: 20px;">
                                                            <iframe class width="100" name="f184d6fef44c96e"
                                                                    ...
                                                                    style="border: medium none; visibility: visible; width: 123px; height: 20px;"
                                                                    height="1000"></iframe>
                                                        </span>
                                                </div>
                                            </div>
