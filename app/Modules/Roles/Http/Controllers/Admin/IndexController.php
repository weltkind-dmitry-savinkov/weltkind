                    ...
                    if(!$module){
                        ...
                        if (!$users->isEmpty()) {
                            foreach ($users as $user){
                                $permissionEntity               = new Permission();
                                $permissionEntity->module_id    = $module->id;
                                $permissionEntity->read         = 0;
                                $permissionEntity->create       = 0;
                                $permissionEntity->publish      = 0;
                                $permissionEntity->update       = 0;
                                $permissionEntity->delete       = 0;

                                $user->permissions()->save($permissionEntity);
                            }
                        }
