<div class="row fill">
  <div class="col-md-8 fill">
    <div class="crop-container">
      <img src="<?php echo e(asset($img)); ?>" class="img img-responsive">
    </div>
  </div>
  <div class="col-md-4 fill">
    <div class="text-center">
      ...
      <br>
      <button class="btn btn-primary" onclick="performCrop()"><?php echo e(Lang::get('laravel-filemanager::lfm.btn-crop')); ?></button>
      <button class="btn btn-info" onclick="loadItems()"><?php echo e(Lang::get('laravel-filemanager::lfm.btn-cancel')); ?></button>
      <form action="<?php echo e(route('unisharp.lfm.getCrop')); ?>" role='form' name='cropForm' id='cropForm' mathod='post'>
        <input type="hidden" id="img" name="img" value="<?php echo e($img); ?>">
...
<script>
  ...
  function performCrop() {
    $.ajax({
      type: "GET",
      dataType: "text",
      url: "<?php echo e(route('unisharp.lfm.getCropimage')); ?>",
      data: {
        img: '<?php echo e($img); ?>',
