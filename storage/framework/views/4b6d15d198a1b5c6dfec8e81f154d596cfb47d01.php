...
<div class="layout layout_line">
    <div class="layout__wrapper">
        <section class="block-note">
            <h2 class="block-note__title"><?php echo widget('advertisement'); ?></h2>
        </section>
    </div>
</div>
<div class="layout">
    <div class="layout__wrapper">
        <?php echo $__env->make('portfolio::main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>
<div class="layout">
    <div class="layout__wrapper">
            ...
            <div class="row">
                <div class="col_md_5">
                    <div class="block-home__clients">
                        <?php echo $__env->make('clients::main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
